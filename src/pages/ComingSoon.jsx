  ...
  return (
    ...
    >
      ...
      <g transform="translate(155 55) rotate(28)">
        ...
        <path d="M28 175 Q40 210 52 175 Q40 188 28 175Z" fill="#ff9f1a" />
        <path d="M33 175 Q40 198 47 175 Q40 182 33 175Z" fill="#ffe066" />
      </g>
    </svg>
  )
}
...
function LogoMark() {
  return (
    ...
    >
      ...
      <path d="M14 28 L34 16 L22 32 L20 26 Z" fill="#e84c4c" />
      <path d="M14 28 L22 32 L20 26 Z" fill="#f5c518" />
    </svg>
  )
}

/**
 * Temporary root landing page.
 * When the real site ships, remove this page and point `/` at a Home page
 * (or About) inside the Layout routes in App.jsx.
 */
function ComingSoon() {
    ...
    <div className="coming-soon-page">
      ...
      >
        <div className="coming-soon-content">
          ...
          <h1 id="headline" className="coming-soon-headline">
            Website under
            <br />
            construction
          </h1>
